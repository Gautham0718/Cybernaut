    ...
    <div className="sp">
      ...
      <div className="scroll-content">
          <div className="pg1">
            ...
            <h4>The basic idea behind Cybernaut</h4>
            <p>Cybernaut is a registered startup company under MSME that has its vision of providing equal educational opportunities to everyone.
